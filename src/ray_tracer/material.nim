...
proc initDielectric*(indexOfRefraction: float64): MaterialType =
    return MaterialType(kind: DielectricKind, d: Dielectric(
...
proc scatter*(m: Lambertian, r: Ray, rec: HitRecord, attenuation: var Vec3,
...
proc scatter*(m: Metal, r: Ray, rec: HitRecord, attenuation: var Vec3,
        scattered: var Ray): bool =
...
proc scatter*(m: Dielectric, r: Ray, rec: HitRecord, attenuation: var Vec3,
        scattered: var Ray): bool =
...
proc scatter*(m: MaterialType, r: Ray, rec: HitRecord, attenuation: var Vec3,
        scattered: var Ray): bool =
    case m.kind
